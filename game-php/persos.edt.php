...
<h1> Edit du personnage </h1>
    ...
    <form action="" method="post" >
        ...
        <div>
            ...
            <input type="text" name="name" id="name" placeholder="Entrez un nouveau nom" required>*
            <br><br>
        </div>
            <input type="submit" class="btnconnexion" value="Editer" name="send" >
        <div>
